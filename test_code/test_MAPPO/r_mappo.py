...
from util import get_gard_norm, huber_loss, mse_loss
...
class R_MAPPO(object):
    ...
    def cal_value_loss(self, values, value_preds_batch, return_batch, active_masks_batch):
        ...
        :return value_loss:  (torch.Tensor) value functio loss.
        '''
    ...
    def ppo_update(self, sample, update_actor=True):
        ...
        adv_targ, available_action_batch = sample
        ...
        values, action_log_probs, dist_entropy = self.policy.evaluate_actions(
            share_obs_batch, obs_batch, rnn_states_batch, rnn_states_critic_batch, actions_batch,
            masks_batch, available_action_batch, active_masks_batch
        )
        ...
        if self._use_max_grad_norm:
            actor_grad_norm = nn.utils.clip_grad_norm(self.policy.actor.parameters(), self.max_grad_norm)
        else:
