...
def get_config():
    ...
    Network parameters:
        ...
        --use_centralized_V
            by default True, use centralized training mode; or else use decentralized training mode.
        --stacked_frames <int>
            Number of input frames which should be stacked together.
        --hidden_size <int>
        ...
        --use_orthogonal
            by default True, use Orthogonal initialization for weights and 0 initialization for biases. or else, will
            use xavier uniform inilialization.
        --gain
    ...
    PPO parameters:
        ...
        --use_proper_time_limits
            by default, the return value does consider limits of time. If set, compute returns with considering time
            limits factor.
        --use_huber_loss
