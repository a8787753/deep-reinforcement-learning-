...
from transformer_act import discrete_autoregreesive_act
from transformer_act import discrete_parallel_act
from transformer_act import continuous_autoregreesive_act
from transformer_act import continuous_parallel_act
...
class MultiAgentTransformer(nn.Module):
    def __init__(self, state_dim, obs_dim, action_dim, n_agent, n_block, n_embd, n_head,
                 encode_state=False, device=torch.device("cpu"), action_type="Discrete",
    ...
    def forward(self, state, obs, action, available_actions=None):
        # state: (batch, n_agents, state_dim)
